...
export const STEP_INTROS: Record<StepId, StepIntro> = {
  ...
  inspection: {
    greeting:
      "Осмотр по разделам. Выберите раздел ниже — предложу загрузить фото или покажу уже собранный коллаж. На каждом фото можно поставить элемент, вердикт и теги вручную или через ИИ.",
    chips: [],
  },
