...
export const STEP_INTROS: Record<StepId, StepIntro> = {
  car: {
    greeting:
      "Начнём с автомобиля. Продиктуйте VIN (или скажите, что нечитаемый), пробег, госномер, город осмотра и ссылку на объявление. Сразу же — марка, модель, поколение, год, двигатель, КПП, привод и цвет. Дату осмотра можно выбрать справа.",
    needsDate: true,
    chips: [
