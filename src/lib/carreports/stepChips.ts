...
export const STEP_INTROS: Record<StepId, StepIntro> = {
  ...
  inspection: {
    greeting:
      "Осмотр по разделам и элементам. Выберите раздел → элемент в карточке ниже, поставьте вердикт «Без замечаний / Мелкие / Серьёзные» и отметьте теги. Можно надиктовать заметку — ИИ распределит её по элементам активного раздела. Прикрепите фото для конкретного элемента кнопкой 📷.",
    chips: [],
  },
