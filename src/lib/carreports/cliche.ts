...
Уже зафиксированные теги (повторять их словами в тексте НЕ нужно):
...
- Не дублируй словами то, что уже выражено тегами выше.
- Короткие предложения, без вводных слов и канцелярита.
- Если исходная заметка пустая или не содержит информации — верни её без изменений.
