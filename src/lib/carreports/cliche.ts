...
/**
 * Нормализация пользовательских тегов: исправление опечаток и сокращение
 * длинных формулировок до короткого технического словосочетания.
 */
...
Ответ — СТРОГО валидный JSON одним объектом:
{ "tags": ["<нормализованный тег 1>", "<нормализованный тег 2>", ...] }
